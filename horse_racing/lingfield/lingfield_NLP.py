...
data = pd.read_csv('lingfield_NLP_data.csv')

# Preprocess the data
#fill the na data with horse
data=data.fillna('horse')
...
train_data, val_data = train_test_split(data, test_size=0.8, random_state=42)
